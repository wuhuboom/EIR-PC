<template>
  <div class="subscribe-main m-t-0 p-t-0">
    <div class="subscribe-title">
      <div class="cp-date-picker-main subscribe-picker">
          ...
          <section class="wh_container">
            <div class="wh_content_all">
              ...
              <div class="wh_content">
                ...
                <div class="wh_content_item">
                  <div class="wh_item_date wh_isToday">17</div>
                </div>
                <div class="wh_content_item">
                  <div class="wh_item_date">18</div>
                </div>
                <div class="wh_content_item">
      ...
      <div class="select-category-main" style="margin-left: 18px">
        ...
        <div class="cp-cascader-main" style="width: 117px; height: 26px">
          <div class="cp-cascader-btn" style="color: rgb(51, 51, 51)">
          ...
          <div class="cp-cascader-items">
            ...
            >
              <div
                class="cp-cascader-column cp-cascader-column-border"
                style="width: 117px"
              >
                <div class="cp-cascader-item cp-cascader-item-active">
                  <span class="cp-cascader-item-span">全部</span>
                  <i class="el-icon-arrow-right cp-cascader-item-i"></i>
                </div>
                <div class="cp-cascader-item">
                  <span class="cp-cascader-item-span">时时彩</span>
                  <i class="el-icon-arrow-right cp-cascader-item-i"></i>
                </div>
                <div class="cp-cascader-item">
                  <span class="cp-cascader-item-span">11选5</span>
                  <i class="el-icon-arrow-right cp-cascader-item-i"></i>
                </div>
                <div class="cp-cascader-item">
                  <span class="cp-cascader-item-span">低频彩</span>
                  <i class="el-icon-arrow-right cp-cascader-item-i"></i>
                </div>
              </div>
              <div class="cp-cascader-column" style="width: 117px">
                <div class="cp-cascader-item cp-cascader-item-active">
                  <span class="cp-cascader-item-span">全部</span>
                  <!---->
                </div>
      ...
      <div class="cp-button-main subscribe-btn">
        <!---->
        查询
      </div>
    </div>
    <div class="custom-table-container">
      <table rules="all" class="custom-table">
        <tr>
          <th height="40" width="180px;">游戏</th>
          <th height="40" width="95px;">发起人</th>
          <th height="40" width="65px;">认购金额</th>
          <th height="40" width="65px;">跟单次数</th>
          <th height="40" width="65px;">已跟次数</th>
          <th height="40" width="60px;">状态</th>
          <th height="40" width="145px;">定制时间</th>
          <th height="40" width="50px;">操作</th>
        </tr>
      </table>
