    ...
    >
      <div class="chart-table container1" style="width: 100%">
        ...
        >
          ...
          <template v-for="(v, idx) in item.ballThree?.zs">
            <div
              :key="idx"
          ...
          <div class="table-row bg-blue" style="flex: 10 1 0%">
            <div
              class="table-cell"
              style="flex: 1 1 0%"
              v-for="(v, idx) in item.threeMiss?.zs"
              :key="idx"
            >
              <div
                class="gold-ball"
          ...
          <div class="table-row bg-yellow" style="flex: 10 1 0%">
            <div
              class="table-cell"
              style="flex: 1 1 0%"
              v-for="(v, idx) in item.spanThree?.zs"
              :key="idx"
            >
              <div
...
export default {
  ...
  methods: {
    ...
    getFirstThree(arr) {
      ...
      const start = Math.floor((arr.length - 3) / 2); // 计算中间起始索引
      return arr.slice(start, start + 3); // 提取中间三位数字
