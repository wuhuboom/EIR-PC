    ...
    >
      <div class="chart-table container1" style="width: 100%">
        <div
          ...
          :key="item.id"
        >
          <div class="table-cell" style="width: 90px">{{ item.cycleNum }}</div>
          <div class="table-cell" style="width: 70px">{{ item.openNum }}</div>
          ...
          <div
            v-if="item.openNumArr[0] === item.openNumArr[1]"
            class="table-cell bg-beigo green-cell"
            style="flex: 1 1 0%"
          >
            对
          </div>
          <div v-else class="table-cell bg-beigo" style="flex: 1 1 0%">
            {{ item.ballTwo1 }}
          </div>
          <div class="table-row bg-blue" style="flex: 10 1 0%">
            <div
              class="table-cell"
              style="flex: 1 1 0%"
              v-for="(v, idx) in item.towMiss?.he"
              :key="idx"
            >
              <div
                class="gold-ball"
          ...
          <div class="table-row bg-yellow" style="flex: 10 1 0%">
            <div
              class="table-cell"
              style="flex: 1 1 0%"
              v-for="(v, idx) in item.spanTwo?.he"
              :key="idx"
            >
              <div
    ...
    tableData() {
      return this.data.map((item) => {
        ...
        return {
          ...
          towMiss: JSON.parse(item.towMiss),
          spanTwo: JSON.parse(item.spanTwo),
        };
      });
    },
  },
